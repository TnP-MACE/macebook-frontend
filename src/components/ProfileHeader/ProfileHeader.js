                        ...
                        <div className="profile-header-section-2">
                            ...
                            <div className="profile-userDetails">
                                ...
                                <span className="batch">
                                    {this.props.location} . Batch of '{this.props.batch} . {this.props.dept}
                                </span>
                        ...
                        <div className="profile-header-section-3">
                            <div className="profile-header-btnContainer">
                                <div className="profile-header-userButtons">
                                    <button className="profile-header-btn1">
                                        {this.props.self ? "Setting" : "Message"}
                                    </button>
                                    <button className="profile-header-btn2">
                                        {this.props.self ? "Edit Profile" : "Connect"}
                                    </button>
                                </div>
                            </div>
                        </div>
