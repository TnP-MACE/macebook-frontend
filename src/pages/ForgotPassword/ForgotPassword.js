            ...
            return (
                <div className="container">
                    ...
                    <div className="ForgotPassword__container-white container">
                        ...
                        <div className="ForgotPassword__container-white__description">
                            Please check your mail for the One Time Password
                        </div>
                        <form onSubmit={handleSubmit}>
                            <div className="ForgotPassword__container-white__otp">
                                <input
                                    name="otp"
                                    type="text"
                                    placeholder="OTP"
                            ...
                            <div className="ForgotPassword__container-white__newpassword">
                                {" "}
                                <input
                                    name="newpassword"
                                    type="password"
                            ...
                            {errors.newpassword && touched.newpassword && (
                                <div className="ForgotPassword__container-white__error-message">
                                    {errors.newpassword}
                                </div>
                            )}

                            <div className="ForgotPassword__container-white__confirmpassword">
                                {" "}
                                <input
