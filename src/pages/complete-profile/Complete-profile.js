...
const Completeprofile = () => {
    ...
    return (
        <Formik
            initialValues={{
                cover: "", profile: "", bio: "", username: "", fullname: "",
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="container">
                                    ...
                                    <div className="Completion__cover-container">
                                        <div className="Completion__cover"><img id="cover-img" className="Completion__cover-file-ico" /></div>
                                        <div className="Completion__cover-image-btn-container">

                                            <label htmlFor="cover-input" id="cover-input-label"><img src={DocImage}/></label>
                                            <input className="Completion__cover-btn"
                                                   type="file"
                                                   name="cover"
                                                   value={values.cover}
                                                   onChange={(e) => {
                                    ...
                                    <div className="Completion__profile-picture-container">
                                        <img className="Completion__profile-picture"
                                             id="profile-img"
                                        />
                                        <img className="Completion__profile-picture"
                                             ...
                                             src={profilepic}
                                        />
                                        <label htmlFor="profile-input"><span className="Completion__profile-picture-btn">Upload Profile Picture</span></label>
                                        <input
                                               type="file"
                                               name="profile"
                                    ...
                                    <label htmlFor="cover-input-change" style={{display:"none",float:"right"}} id="cover-change-label"><span>Change cover photo</span></label>
                                        ...
                                        <div className="Completion__fields-container">
                                            ...
                                            <div className="Completion__row">
                                                <div className="Completion__skills-container">
                                                    ...
                                                    <div className="Completion__skills-box">
                                                        <CustomSelect isMulti={true}
                                                                      ...
                                                                      onChange={onChangeInput} options={options}
                                                ...
                                                <div className="Completion__links-container">
                                                    ...
                                                    <div
                                                        className="Completion__form-group Completion__form-group-skills">
